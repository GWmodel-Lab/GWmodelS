...
QgsAttributeTableDialog::QgsAttributeTableDialog( QgsVectorLayer *layer,  QgsMapCanvas* myMapCanvas, QWidget *parent,QgsAttributeTableFilterModel::FilterMode initialMode, Qt::WindowFlags flags )
...
//  mEditorContext.setVectorLayerTools( QgisApp::instance()->vectorLayerTools() );
  mEditorContext.setMapCanvas( this->mymapCanvas );
...
//  mEditorContext.setCadDockWidget( QgisApp::instance()->cadDockWidget() );
  ...
  {
    QgsMapCanvas *mc = this->mymapCanvas;
  ...
  mMainView->init( mLayer, this->mymapCanvas, r, mEditorContext, false );
