#ifndef GWMSYMBOLEDITORDIALOG_H
#define GWMSYMBOLEDITORDIALOG_H
...
class GwmSymbolEditorDialog : public QDialog
{
    Q_OBJECT
public:
    explicit GwmSymbolEditorDialog(QgsVectorLayer* vectorLayer,QWidget *parent = nullptr);
    ~GwmSymbolEditorDialog();

    QgsFeatureRenderer *selectedRenderer() const;
    void setSelectedRenderer(QgsFeatureRenderer *selectedRenderer);
...
private:
    QgsFeatureRenderer* mSelectedRenderer = nullptr;
