...
class QgsAttributeTableDialog : public QDialog, private Ui::QgsAttributeTableDialog, private QgsExpressionContextGenerator
{
    Q_OBJECT
  ...
  public:
     ...
     */
    QgsAttributeTableDialog( QgsVectorLayer *layer,  QgsMapCanvas* myMapCanvas, QWidget *parent = nullptr,QgsAttributeTableFilterModel::FilterMode initialMode = QgsAttributeTableFilterModel::ShowAll, Qt::WindowFlags flags = Qt::Window );
