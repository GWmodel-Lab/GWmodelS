...
void QgsLayoutManagerDialog::mAddButton_clicked()
{
  ...
  {
    QString title;
    if ( !GwmApp::Instance()->uniqueLayoutTitle( this, title, true, QgsMasterLayoutInterface::PrintLayout, storedTitle ) )
    {
      return;
    }
...
{
  QString title;
  if ( !GwmApp::Instance()->uniqueLayoutTitle( this, title, true, QgsMasterLayoutInterface::Report ) )
  {
    return;
  }
  ...
  GwmApp::Instance()->openLayoutDesignerDialog( report.get() );
...
void QgsLayoutManagerDialog::duplicateClicked()
{
  ...
  QString newTitle;
  if ( !GwmApp::Instance()->uniqueLayoutTitle( this, newTitle, false, currentLayout->layoutType(), tr( "%1 copy" ).arg( currentTitle ) ) )
  {
    return;
  }
...
void QgsLayoutManagerDialog::renameClicked()
{
  ...
  QString currentTitle = currentLayout->name();
  QString newTitle;
  if ( !GwmApp::Instance()->uniqueLayoutTitle( this, newTitle, false, currentLayout->layoutType(), currentTitle ) )
  {
    return;
  }
