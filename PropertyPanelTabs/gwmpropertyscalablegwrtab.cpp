...
//              使用组件赋值
              ...
              out << "Polynomial:   "; out << ui->lblPolynomial->text() <<endl;
              out << "" << endl;
              out << "**********************************************" << endl;
              out << "" << endl;

              out << "  LOOCV Results"<<endl;
              out << "----------------------------------------------"<<endl;
              out << "b.tilded:  "; out << ui->lblBtilde->text() <<endl;
              out << "alpha:   "; out << ui->lblAlpha->text() <<endl;
              out << "CV: "; out << ui->lblCV->text() << endl;
              out << "" << endl;
              out << "**********************************************" << endl;
              out << "" << endl;
